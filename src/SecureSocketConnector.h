//
// SecureSocketConnector.h
//
// Definition of the SocketConnector class using a SecureStreamSocket.
//
...
#ifndef Net_SecureSocketConnector_INCLUDED
#define Net_SecureSocketConnector_INCLUDED
...
#endif // Net_SecureSocketConnector_INCLUDED